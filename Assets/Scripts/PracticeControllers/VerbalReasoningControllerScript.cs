...
public class VerbalReasoningControllerScript : MonoBehaviour
{
    ...
    public void OnInputFieldSubmitted(string message)
    {
        ...
        chatGPTManager.AskChatGPT(message, HandleChatGPTResponse);
    }

    public void initialChatQuestion()
    {
        chatBox.RegisterChat("System", "Loading ...", getSystemChatStyle());
        chatGPTManager.AskChatGPT(getInitalQuestion(), HandleChatGPTResponse);
    }


    void HandleChatGPTResponse(string response)
    { 
        UltimateChatBox.ChatStyle chatStyle = new UltimateChatBox.ChatStyle();
    ...
    private string getInitalQuestion()
    {
        return "Explain why I got this question right/wrong. Passage: " + questionList[currentlySelectedQuestion].resource + " Question: " + questionList[currentlySelectedQuestion].questionText + " Answer: " + questionList[currentlySelectedQuestion].questionAnswer + " My Answer: " + questionList[currentlySelectedQuestion].usersAnswer + " Reasoning: " + questionList[currentlySelectedQuestion].answeringReason + " Options 1: " + questionList[currentlySelectedQuestion].option1Label + ", Option 2: " + questionList[currentlySelectedQuestion].option2Label + ", Option 3: " + questionList[currentlySelectedQuestion].option3Label + ", Option 4: " + questionList[currentlySelectedQuestion].option4Label;
    }
